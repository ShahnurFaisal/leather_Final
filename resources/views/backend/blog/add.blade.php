        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <h5 class="card-title text-primary" style="text-transform: uppercase">Blog Add</h5>
                               @include('error')
                            <div class="row">
                                <!-- Basic Layout -->
                                <div class="col-xxl">
                                      ...
                                      <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class=" mb-3 col-4">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control" name="title" id="basic-default-name" placeholder="Blog Title" required />
                                                </div>
                                              </div>
