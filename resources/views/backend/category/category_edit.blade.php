        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <h5 class="card-title text-primary" style="text-transform: uppercase">Category Edit</h5>
                                    ...
                                    <div class="card-body">
                                      ...
                                      <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                          ...
                                          <div class="col-sm-10">
                                            <input type="text" class="form-control" name="category_name" id="basic-default-name" value="{{ $data['category']->category_name }}" />
                                          </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                              ...
                                              <img style="width:200px;height:200px" id="showImage" src="{{ asset($data['category']->photo ? $data['category']->photo : 'backend/img/previewImage.png') }}" alt="" class="image-style mb-3">
                                          </div>
                                          </div>
