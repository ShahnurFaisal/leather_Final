<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Leather</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Layouts -->
      <li class="menu-item {{ $data['active_menu'] == 'category_add' ||  $data['active_menu'] == 'category_edit' || $data['active_menu'] == 'category_list' ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          <li class="menu-item {{ $data['active_menu'] == 'category_add'  ? 'active' : '' }}">
            <a href="{{ route('admin.category.add') }}" class="menu-link">
              <div data-i18n="Without menu">Category Add</div>
            </a>
          </li>
          <li class="menu-item {{ $data['active_menu'] == 'category_list' ? 'active' : '' }}">
      ...
      <li class="menu-item {{ $data['active_menu'] == 'product_add' || $data['active_menu'] == 'product_edit' || $data['active_menu'] == 'product_list' ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          <li class="menu-item {{ $data['active_menu'] == 'product_add' ? 'active' : '' }}">
      ...
      <li class="menu-item {{ $data['active_menu'] == 'blog_add' || $data['active_menu'] == 'blog_edit' || $data['active_menu'] == 'blog_list' ? 'active open' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-layout"></i>
        ...
        <ul class="menu-sub">
          <li class="menu-item {{ $data['active_menu'] == 'blog_add' ? 'active' : '' }}">
            <a href="{{ route('admin.blog.add') }}" class="menu-link">
              <div data-i18n="Without menu">Blog Add</div>
            </a>
          </li>
          <li class="menu-item {{ $data['active_menu'] == 'blog_list' ? 'active' : '' }}">
            <a href="{{ route('admin.blog.list') }}" class="menu-link">
              <div data-i18n="Without navbar">Blog List</div>
            </a>
          </li>

        </ul>
      </li>
      <li class="menu-item {{ $data['active_menu'] == 'about_add' ? 'active' : '' }}">
        <a href="{{ route('admin.about.add') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
