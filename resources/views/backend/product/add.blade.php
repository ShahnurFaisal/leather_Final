        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <h5 class="card-title text-primary" style="text-transform: uppercase">Product Add</h5>
                               @include('error')
                            <div class="row">
                                <!-- Basic Layout -->
                                <div class="col-xxl">
                                      ...
                                      <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class=" mb-3 col-4">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control" name="name" id="basic-default-name" placeholder="Product Name" required />
                                                </div>
                                              </div>
                                              ...
                                              <div class="mb-3 col-4">
                                                ...
                                                <div class="characteristics" id="characteristics">
                                                    <div class="row character-set" id="set1">
                                                        <div class="col-sm-4">
                                                            <input name="title[]" type="text" class="form-control my-2 mb-1" />
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <input name="details[]" type="text" class="form-control my-2 mb-1" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3 col-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="file" class="form-control my-2" name="photo_gallery[]" id="image" multiple/>
                                                ...
                                                <div class=" mb-3 col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="primary_description" id="">
                                                    </div>
                                            <div class=" mb-3 col-12">
                                                <label class=" col-form-label" for="basic-default-name">Description*</label>
                                               <textarea class="form-control" name="description" id="" style="width: 100%" cols="30" rows="10"></textarea>
                                              </div>
